 ...
 */
public class PiAppTest extends TestBaseWithSpark2 {
  ...
  public void test() throws Exception {
    ...
    ApplicationManager appManager = deployApplication(PiApp.class);
    // Start the Flow
...
//    metrics.waitForProcessed(200, 10, TimeUnit.SECONDS);
    ...
    SparkManager sparkManager = appManager.getSparkManager(PiProgram.class.getSimpleName()).start();
    sparkManager.waitForRun(ProgramRunStatus.COMPLETED, 60, TimeUnit.SECONDS);

//    flowManager.stop();

    // Start CentersService
//    ServiceManager serviceManager = appManager.getServiceManager(PiApp.CentersService.SERVICE_NAME).start();
